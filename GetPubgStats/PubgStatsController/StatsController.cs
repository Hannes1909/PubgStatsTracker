...
using PubgStatsController.PubgApi;
using System.Linq;
using Database;
using System;

namespace PubgStatsController
{
    public class StatsController
    {
        private readonly PubgApiClient apiClient;
        private readonly DbLayer dbLayer;

        public StatsController(string databaseConnectionString, string pubgApiBaseUrl, string[] pubgApiKeys)
        {
            this.dbLayer = new DbLayer(databaseConnectionString, this.FetchMatchdataFromPubgAPI);
            this.apiClient = new PubgApiClient(pubgApiBaseUrl, pubgApiKeys);
        }
